System.register(['angular2/core', './courses/courses.component', './authors/authors.component', './likes/likes.component', './votes-counter/votes-counter.component', './tweets-list/tweets-list.component', './zippy/zippy.component', './subscription-form/subscription-form.component', './change-password-form/change-password-form.component'], function(exports_1, context_1) {
    ...
    var core_1, courses_component_1, authors_component_1, likes_component_1, votes_counter_component_1, tweets_list_component_1, zippy_component_1, subscription_form_component_1, change_password_form_component_1;
    var AppComponent;
    return {
        setters:[
            function (core_1_1) {
